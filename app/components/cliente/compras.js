...
export class ClienteCompras extends Presenter {
    ...
    template() {
        const compras = JSON.parse(localStorage.getItem('compras') || '[]').reverse();
        ...
        if (compras.length === 0) {
            return `
                <div class="compras-vacio">
                    ...
                    <a href="/c/libros" data-link class="btn btn-primary">Explorar catálogo</a>
                </div>
            `;
        }
                            ...
                            <div class="compra-card">
                                <div class="compra-header">
                                    <div class="compra-info">
                                        ...
                                        <p class="compra-fecha">${fecha.toLocaleDateString('es-ES', {
                                            day: '2-digit',
                                            month: 'long',
                                            year: 'numeric',
                                            hour: '2-digit',
                                    ...
                                    <div class="compra-total">
                                        ...
                                        <span class="total-valor">${compra.total.toFixed(2)}€</span>
                                    </div>
                                </div>
                                        ...
                                        return `
                                            <div class="compra-item">
                                                ...
                                                <div class="item-precio">
                                                    ${(libro.precio * item.cantidad).toFixed(2)}€
                                                </div>
                                            </div>
                                        `;
                                    }).join('')}
