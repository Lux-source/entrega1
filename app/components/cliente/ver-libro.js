            ...
            <div class="libro-detalle">
                ...
                <div class="detalle-content">
                    <div class="detalle-imagen">
                        <img src="${this.libro.portada}" alt="${this.libro.titulo}">
                    </div>
                    ...
                    <div class="detalle-info">
                        ...
                        <div class="info-grid">
                            ...
                            <div class="info-item">
                                ...
                                <span class="info-value">${this.libro.idioma}</span>
                            </div>
                            <div class="info-item">
                                <span class="info-label">ISBN:</span>
                                <span class="info-value">${this.libro.isbn}</span>
                            </div>
                        </div>
                        ...
                        <div class="compra-info">
                            <div class="precio-stock">
                                <p class="precio-grande">${this.libro.precio.toFixed(2)}€</p>
                                <p class="stock ${this.libro.stock === 0 ? 'out-of-stock' : ''}">
                                    ${this.libro.stock > 0 ? `${this.libro.stock} disponibles` : 'Agotado'}
                                </p>
                            </div>
    ...
    bind() {
        ...
        if (btnAddCart) {
            btnAddCart.addEventListener('click', () => {
                const cantidad = parseInt(this.container.querySelector('#cantidad').value);
