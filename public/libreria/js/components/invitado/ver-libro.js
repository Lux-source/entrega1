        ...
        return `
            <div class="libro-detalle">
                <div class="libro-header">
                    <img src="${libro.portada}" alt="${libro.titulo}" class="libro-portada">
                    <div class="libro-info">
                        <h1>${libro.titulo}</h1>
                        <p class="autor">Por ${libro.autor}</p>
                        <p class="isbn">ISBN: ${libro.isbn}</p>
                        <p class="precio">${libro.precio.toFixed(2)}€</p>
                        <p class="stock">${libro.stock > 0 ? `✓ En stock (${libro.stock} disponibles)` : '✗ Agotado'}</p>
                ...
                <div class="libro-detalles">
                    ...
                    <ul>
                        ...
                        <li><strong>Idioma:</strong> ${libro.idioma || 'Español'}</li>
                    </ul>
                </div>
            </div>
        `;
